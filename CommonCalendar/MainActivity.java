        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               /* mainData a = new mainData("walking","12:00-23:00");
                mainData b = new mainData("RUN","17:00-18:00");
                mainData c =new mainData("HMM","12:30-13:00");
                dataList.add(a);
                dataList.add(b);
                dataList.add(c);
                if(selectedDate==null) {
                    selectedDate = String.valueOf(CalendarDay.today().getDay()  + String.valueOf(CalendarDay.today().getMonth()  + String.valueOf(CalendarDay.today().getYear())));
                    dateToDecorate = CalendarDay.today();
                    insertEvents(dataList,selectedDate);
                }
                else
